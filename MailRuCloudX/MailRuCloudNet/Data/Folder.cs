...
namespace MailRuCloudClient.Data
{
    ...
    public class Folder : CloudStructureEntryBase
    {
        ...
        public /*async Task<Folder>*/ Folder Publish()
        {
        ...
        public /*async Task<Folder>*/ Folder Unpublish()
        {
        ...
        {
            //await 
            this.Client.Remove(this.FullPath);
            //await 
        ...
        public /*async Task<Folder>*/ Folder Rename(string newName)
        {
        ...
        public /*async Task<Folder>*/ Folder Copy(string destFolderPath)
        {
        ...
        /// <param name="destFolderPath">The destination path of current folder.</param>
        /// <returns>The new foler info in the new location.</returns>
        public /*async Task<Folder>*/ Folder Move(string destFolderPath)
        {
        ...
        (
            List<string> fileAndFolderNames, 
            string destZipArchiveName, string destFolderPath
        )
        {
            ...
            return /*await*/ this.Client.DownloadItemsAsZIPArchive(
                fileAndFolderNames, destZipArchiveName, destFolderPath);
        }
        ...
        /// <returns>The simple task.</returns>
        public /*async Task*/ bool DownloadFolderAsZIP(Stream destStream)
        {
            //await 
            this.Client.DownloadItemsAsZIPArchive(new List<string> { this.FullPath }, 
                          destStream);
            return true;
        }
        ...
        public /*async Task<FileInfo>*/ FileInfo DownloadFolderAsZIP(
            string destZipArchiveName, string destFolderPath)
        {
            ...
            return /*await*/ this.Client.DownloadItemsAsZIPArchive(
                new List<string> { this.FullPath }, destZipArchiveName, destFolderPath);
        }
        ...
        public /*async Task<Folder>*/ Folder CreateFolder(string folderName)
        {
            if (folderName.Contains("/"))
            {
                throw new ArgumentException(
                    "The nested subdirectories is not allowed. " +
                    "Use CloudClient.CreateFolder instead.", 
                    nameof(folderName));
            }
        ...
        public /*async Task<File>*/ File UploadFile(string sourceFilePath)
        {
        ...
        /// <returns>The created file info.</returns>
        public /*async Task<File>*/ File UploadFile(string fileName, Stream content)
        {
        ...
        /// <returns>The simple task.</returns>
        internal /*async Task*/ bool UpdateFolderInfo(bool forceUpdate = false)
        {
            ...
            if (this.Items == null 
                || (diffTime > 1.0 
                   && 
                   (currentDiskSpace = 
                   /*await*/ this.Account.GetDiskUsage()).Used.DefaultValue != this.prevDiskUsed)
                || forceUpdate)
            {
