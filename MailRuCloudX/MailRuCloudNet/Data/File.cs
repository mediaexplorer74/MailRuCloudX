...
namespace MailRuCloudClient.Data
{
    ...
    public class File : CloudStructureEntryBase
    {
        ...
        public /*async Task<string>*/ string GetFileOneTimeDirectLink()
        {
        ...
        public /*async Task<File>*/ File Publish()
        {
        ...
        public /*async Task<File>*/File Unpublish()
        {
        ...
        public /*async Task<History[]>*/History[] GetFileHistory()
        {
        ...
        public /*async Task<File>*/File Rename(string newName)
        {
        ...
        public /*async Task<File>*/File Copy(string destFolderPath)
        {
        ...
        public /*async Task<File>*/File Move(string destFolderPath)
        {
        ...
        /// <returns>The simple task.</returns>
        public /*async Task*/ bool DownloadFileAsZIP(Stream destStream)
        {
            //await 
            this.Client.DownloadItemsAsZIPArchive(new List<string> { this.FullPath }, destStream);
            return true;
        }
        ...
        public /*async Task<FileInfo>*/FileInfo DownloadFileAsZIP(string destZipArchiveName, string destFolderPath)
        {
